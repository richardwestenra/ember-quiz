...
//# sourceMappingURL=../vendor/iframeresizer.map
...
iFrameResize({
	...
	messageCallback: function(m){
		if(typeof window.jQuery != "undefined"){
			$(function(){
				var $body = $('body');
				var s = $body.scrollTop() + m.message*1;
				$body.stop().animate({ scrollTop: s }, 999);
			});
		} else {
			var s = document.body.scrollTop + m.message*1;
			smoothScrollTo(s, 500);
		}
    }
});
