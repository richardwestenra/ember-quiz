...
App.Quiz = DS.Model.extend({
  ...
  toIframe: function(){
    ...
    return '<iframe style="box-shadow:0 0 2px rgba(0,0,0,0.3);" src="'+url+'/out?quiz='+this.get('id')+'" width="100%" height="" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><script src="'+url+'/out/vendor/iframeresizer.js"></script>';
  }
