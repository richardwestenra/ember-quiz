...
App.QuizzesController = Em.ArrayController.extend({
  ...
  actions: {
    ...
    showEmbed: function(quiz){
      ...
      var scripts = '<script>window.jQuery || document.write(\'<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"><\/script>\')</script><script src="https://cdn.rawgit.com/npr/responsiveiframe/master/dist/jquery.responsiveiframe.min.js"></script>';
      var iframe = '<iframe style="box-shadow:0 0 2px rgba(0,0,0,0.3);" src="'+url+'" width="100%" height="900" frameborder="0" marginheight="0" marginwidth="0"></iframe>';
      var init = '<script>;(function($){ $(function(){ $(\'.rasIframe\').responsiveIframe({ xdomain: \'*\'});}); })(jQuery);</script>';
      var msg = 'Copy the following code and paste it into an HTML page to embed quiz in an iframe: \n\n' + scripts + iframe + init;
      alert(msg);
    },
