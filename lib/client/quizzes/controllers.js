...
App.QuizzesController = Em.ArrayController.extend({
  ...
  actions: {
    ...
    showEmbed: function(quiz){
      ...
      var script = '<script src="' + url + '/out/vendor/iframeresize.js"></script>';
      var iframe = '<iframe style="box-shadow:0 0 2px rgba(0,0,0,0.3);" src="'+url+'/out?quiz='+quiz.get('id')+'" width="100%" height="" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>';
